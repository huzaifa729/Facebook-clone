    ...
    <div className='meassage'>
      ...
      <form>
        ...
        <div className='message-option'>
          <div className='message-icons-nam'>
          ...
          <span className='icon-name'>Live Video</span>
          </div>
          ...
          <span className='icon-name'>Photo/Video</span>
          </div>
          ...
          <span className='icon-name'>Filling/Activity</span>
          </div>
        </div>
    </div>
  )
